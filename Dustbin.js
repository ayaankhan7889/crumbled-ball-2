class Dustbin {
    constructor(x,y){
        ...
        this.leftBody = Bodies.rectangle(this.x-100,this.y-105,20,210,{isStatic:true});
        this.rightBody = Bodies.rectangle(this.x+100,this.y-105,20,210,{isStatic:true});
...
display(){
    ...
    imageMode(CENTER)
    fill("pink")
    image(this.image,0,-105,200,210);
    pop();
}
}